...
public class Agencija {
	...
	public Transakcija pronadjiNajvecuUplatu(String nazivKlijenta, LocalDate min, LocalDate max) {
		...
		if(najveca != null) {
			System.out.println("Najveca transakcija klijenta: " + nazivKlijenta + " za uplatu je: " + najveca.getIznosTransakcije());
		} else {
